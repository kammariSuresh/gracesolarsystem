...
if ($(vlSideMenu).find('.sub-menu, .vl-mega-menu').length != 0) {
  $(vlSideMenu).find('.sub-menu, .vl-mega-menu').parent().append('<button class="vl-menu-close"><img src="assets/imgs/icons/chevron-down.svg" /></button>');
}
...
// if page is empty, redirect to 404 page
